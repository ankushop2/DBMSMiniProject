    ...
    if ($error) {
      ...
      */
      ...
      if (($conn->query($sql))&&($conn->query($sql2)) === TRUE) {
          ...
          $result='<div class="alert alert-danger"><strong>There were an error in creation, Please try again :</strong>'.$error.'</div>';
      }
      $conn->close();
    }
}
    ...
    <div class="col-md-6 col-md-offset-3 loginForm">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="number" name="phNo" class="form-control" value="<?php echo $_POST['phNo']; ?>" />
        </div>
