<?php
	...
	// Selecting Database
	$db = mysql_select_db("bus", $connection);
...
<head>
	...
	<link rel="stylesheet" href="source/bus/css/style.css">
...
<body>
	...
	<div class="main-agileinfo">
		...
		<script src="source/bus/js/jquery.min.js"> </script>
		<script src="source/bus/js/easyResponsiveTabs.js" type="text/javascript"></script>
		...
		<!--//script for portfolio-->
				<!-- Calendar -->
				<link rel="stylesheet" href="source/bus/css/jquery-ui.css" />
				<script src="source/bus/js/jquery-ui.js"></script>
				  <script>
						  $(function() {
